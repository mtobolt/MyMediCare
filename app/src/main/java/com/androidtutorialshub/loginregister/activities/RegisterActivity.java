...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextInputLayout textInputLayoutNurse;
    ...
    private TextInputEditText textInputEditTextNurse;
    ...
    private void initViews() {
        ...
        textInputLayoutNurse = (TextInputLayout) findViewById(R.id.textInputLayoutNurse);
        ...
        textInputEditTextNurse = (TextInputEditText) findViewById(R.id.textInputEditTextNurse);
    ...
    private void postDataToSQLite() {
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextNurse, textInputLayoutNurse, getString(R.string.error_message_nurse))) {
            return;
        }
        if (!inputValidation.isInputEditTextFilled(textInputEditTextAge, textInputLayoutAge, getString(R.string.error_message_age))) {
            return;
        }
        if (!inputValidation.isInputEditTextFilled(textInputEditTextPhoneNumber, textInputLayoutPhoneNumber, getString(R.string.error_message_phoneNum))) {
            return;
        }
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
            ...
            user.setNurseName(textInputEditTextNurse.getText().toString().trim());
    ...
    private void emptyInputEditText() {
        ...
        textInputEditTextNurse.setText(null);
